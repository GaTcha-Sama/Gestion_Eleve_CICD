...
public class GestionEtudiants {
    ...
    private static void enregistrerEtudiants() {
        for (int i = 0; i < etudiants.length; i++) {
            ...
            System.out.print("Note Maths: ");
            double note1 = scanner.nextDouble();

            System.out.print("Note Java: ");
            double note2 = scanner.nextDouble();

            System.out.print("Note C++: ");
            double note3 = scanner.nextDouble();

            System.out.print("Note SQL: ");
            double note4 = scanner.nextDouble();

            System.out.print("Note C# : ");
            double note5 = scanner.nextDouble();

            double moyenne = (note1 + note2 + note3 + note4 + note5) / 5;

            etudiants[i] = new Etudiant(matricule, nom, genre, dateNaissance, note1, note2, note3, note4, note5, moyenne);
        }
    }
